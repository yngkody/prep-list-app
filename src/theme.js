...
export const tokens = (mode) => ({
  ...(mode === "dark"
    ? {
        grey: { 100: "#e0e0e0", 200: "#c2c2c2", 300: "#a3a3a3", 400: "#858585", 500: "#666666", 600: "#525252", 700: "#2b2929ff", 800: "#292929", 900: "#141414" },
  ...
  return {
    palette: {
     ...
     typography: {
        ...
        fontSize: 12,
        h1: { fontFamily: ['Raleway', 'sans-serif'].join(','), fontSize: 40 },
        h2: { fontFamily: ['Raleway', 'sans-serif'].join(','), fontSize: 32 },
        h3: { fontFamily: ['Raleway', 'sans-serif'].join(','), fontSize: 24 },
        h4: { fontFamily: ['Raleway', 'sans-serif'].join(','), fontSize: 20 },
        h5: { fontFamily: ['Raleway', 'sans-serif'].join(','), fontSize: 16 },
        h6: { fontFamily: ['Raleway', 'sans-serif'].join(','), fontSize: 14 },
    },
  };
};
...
// custom hook for using the theme and color mode
